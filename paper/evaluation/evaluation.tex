...
\begin{table}[htbp]
	\centering
	\caption{The predicted features vs the actual features of the top offender (to 1 decimal)}\label{tab:predicted_vs_actual_top}
	\resizebox{\linewidth}{!}{
		\begin{tabular}{lll}
			Label & Actual & Predicted \\ \midrule
			time_since_last_access & 0 & 0.0 \\
			domains_delta & 0 & 0.0 \\
			dest_users_delta & 0 & 0.0 \\
			src_computers_delta & 0 & 0.0 \\
			dest_computers_delta & 0 & 0.0 \\
			percentage_failed_logins & 0.0 & 0.0 \\
			success_failure & 1 & 0.9 \\
			auth_type_0 & 1 & 0.0 \\
			auth_type_1 & 0 & 0.2 \\
			auth_type_2 & 0 & 0.0 \\
			auth_type_3 & 0 & 0.0 \\
			...
			logon_type_7 & 0 & 0.0 \\
			logon_type_8 & 0 & 0.8 \\
			auth_orientation_0 & 0 & 0.6 \\
			auth_orientation_1 & 0 & 0.0 \\
			auth_orientation_2 & 0 & 0.0 \\
			auth_orientation_3 & 0 & 0.0 \\
			auth_orientation_4 & 0 & 0.0 \\
			auth_orientation_5 & 1 & 0.3
		\end{tabular}
	}
\end{table}
